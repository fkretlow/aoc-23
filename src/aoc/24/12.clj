...
(defn find-regions
  ...
  This is a breadth-first-search with two separate queues for the vertices to process. We first
  process all vertices with the same plant, thus exploring whole regions at once. Plots in other
  regions are added to the second queue and processed in the same manner afterwards."
  [grid]
