...
(defn- find-first-and-last-occurence
  "Given any collection of string (or char) `literals`, return the ones that 
  occur first and last in the given string `s` as a vector of two elements."
  [literals s]
...
(defn- sum-up-calibration-values
  "Given a collection of acceptable number `literals`, return the sum 
  of the calibration values for the given `lines.`"
  [literals lines]
